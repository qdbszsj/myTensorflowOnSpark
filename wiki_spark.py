...
parser.add_argument("--images", help="HDFS path to wiki images in parallelized format")
parser.add_argument("--labels", help="HDFS path to wiki labels in parallelized format")
parser.add_argument("--model", help="HDFS path to save/load model during train/inference", default="wiki_model")
...
cluster = TFCluster.run(sc, wiki_dist.map_fun, args, args.cluster_size, num_ps, args.tensorboard, TFCluster.InputMode.SPARK, log_dir=args.model)
if args.mode == "train":
